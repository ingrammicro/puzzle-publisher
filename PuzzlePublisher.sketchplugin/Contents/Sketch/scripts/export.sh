...
${dstSketchPath}/Contents/Resources/sketchtool/bin/sketchtool --new-instance=YES --wait-for-exit=NO --without-waiting=NO --without-activating=YES run ~/Library/Application\ Support/com.bohemiancoding.sketch3/Plugins/PuzzlePublisher.sketchplugin "cmdRun"  --context="{\"file\":\"${fileName}\",\"name\":\"${docName}\",\"commands\":\"export,close\",\"async\":true}"
rm $fileName
